...
() {
  ...
  typeset -g __p9k_instant_prompt_param_sig=$'v141\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-A1\C-Auser_test1%\C-A\C-A\C-A\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A1\C-AUTF-8\C-A\C-A\C-A1\C-A1\C-A/home/user_test1/.oh-my-zsh/custom/themes/powerlevel10k\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-A100'
  local gitstatus_dir=/home/user_test1/.oh-my-zsh/custom/themes/powerlevel10k/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/home/user_test1/.cache/p10k-user_test1
